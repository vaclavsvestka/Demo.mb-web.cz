...
<li class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-user">
        <li class="border-bottom"><a href="#"><i class="fa fa-user" style="margin-right: 5px"></i> {$logged_user.name} {$logged_user.surname}</a></li>
        ...
        <li><a href="/admin/logout"><i class="fa fa-sign-out" style="margin-right: 5px"></i> Odhlásit z administrace</a></li>
    </ul>
            <!-- 
