								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label for="nazev">Název:</label><input type="text" class="form-control" id="nazev" name="nazev" value="{$znacka.nazev}" placeholder="Název">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<select name="aktivni" class="form-control">
												<option value="1" {if $znacka.aktivni == 1}selected{/if}>Ano</option>
												<option value="0" {if $znacka.aktivni == 0}selected{/if}>Ne</option>
											</select>
										</div>
									</div>
								</div>
